---
title: |
  <center> Size matching differentially affects gulpers and mashers frugivorous birds </center>
...
We assessed model fit by computing randomized cumulative probability residuals (Dunn and Smyth 1996), using the DHARMa R package (Hartig 2022; Fig. A1). Both models showed adequate fit to data. The negative trend in the residuals for the consumption probability at gulpers for high size difference was influenced by too few observations, so we preferred to keep the logit-linear model.  
